...
//go:embed tmplMessageLocation.txt
var tmplMessageLocation string

func (tt *templateString) MessageLocation(ml *tele.Location) (string, error) {
	...
	ftmpl_src := "E:/src/goproj/!telegram_bot_telebot/telebot/internal/template/tmplMessageLocation.txt"
	ftmpl_local := "template/tmplMessageLocation.txt"
