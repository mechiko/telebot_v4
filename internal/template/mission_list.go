...
//go:embed tmplMissionList.txt
var tmplMissionList string

func (tt *templateString) MissionList(ml *entity.MissionList) (string, error) {
	defer tt.app.GetRecovery().RecoverLog("MissionList")
	...
	ftmpl_src := "E:/src/goproj/!telegram_bot_telebot/telebot/internal/template/tmplMissionList.txt"
	ftmpl_local := "template/tmplMissionList.txt"
